...
class Rcv extends Model
{
    ...
    {
        return $this->belongsToMany(Sparepart::class,'tb_inventory_detrcv','id_rcv','id_sparepart')->withPivot('qty_po','qty_rcv','keterangan','harga_diterima','total_harga','id_gudang','stok_min');
    }
